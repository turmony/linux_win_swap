...
#print(model)
# tmp = torch.randn((4,24,307,1), dtype=torch.float32).to(device)
# tmp2 = torch.randn((4,48,2), dtype=torch.float32).to(device)
...
best_path = './experiments/SSTBAN/PEMSD4_1dim_307_24_24_5_16_2_8_best_params_19.517197'
